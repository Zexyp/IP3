    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <section>
                ...
                <form method="post" action="{{ route('sale.edit', [$value->id]) }}">
                    @csrf
                    @method('patch')
                    ...
                    <div class="grid grid-cols-2 gap-6">
                        ...
                        <div class="p-6">
                            <a onclick="return confirm('Odejít bez uložení?')" href="{{route('sale.view', [$value->id])}}" class="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded">
                                Zrušit
                            </a>
                            <br>
                            <br>
